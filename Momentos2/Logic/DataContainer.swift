...
import SwiftUI
    ...
    class DataContainer {
        ...
        //TODO: var badgeManager: BadgeManager
        ...
        init(includeSampleMoments: Bool = false) {
            ...
            let schema = Schema([
                Moment.self,
             //TODO:   Badge.self // Añadimos Badge aquí para prepararnos para la Sesión 3
            ])
            ...
            do {
                ...
                //TODO: badgeManager = BadgeManager(modelContainer: modelContainer)
                //TODO: try badgeManager.loadBadgesIfNeeded() // Carga los logros al iniciar
        ...
        private func loadSampleMoments() throws {
            for moment in Moment.sampleData {
                context.insert(moment)
                 //TODO: try badgeManager.unlockBadges(newMoment: moment)
            }
        }
    }
